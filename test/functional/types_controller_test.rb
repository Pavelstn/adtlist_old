...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { alias: @type.alias, isactive: @type.isactive, isdelete: @type.isdelete, name: @type.name }
    end
  ...
  test "should update type" do
    put :update, id: @type, type: { alias: @type.alias, isactive: @type.isactive, isdelete: @type.isdelete, name: @type.name }
    assert_redirected_to type_path(assigns(:type))
  end
